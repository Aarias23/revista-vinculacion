...
# Windows/Ruby environment. This bootstrap loads the required pieces explicitly so
# local commands match the GitHub Pages dependency set without patching gems.
